            ...
            {!!appointment && (
              <Details>
                ...
                <Row>
                  ...
                  <RightSide>{appointment.appointment.date || 'No date'} </RightSide>
                </Row>
                ...
                <Row>
                  ...
                  <RightSide> {appointment.reparation.reparation_name} </RightSide>
                </Row>
                {appointment.appointment.appointment_comment && (
                  <>
                    ...
                    <Row>
                      ...
                      <RightSide> {appointment.appointment.appointment_comment} </RightSide>
                    </Row>
                  </>
                )}
              </Details>
