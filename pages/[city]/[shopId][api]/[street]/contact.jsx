...
import { appointmentConfirmation, appointmentForm, appointmentReview } from '@/components/appointment/modules'
    ...
    try {
      ...
      appointmentConfirmation.actions
        .open({
          ...
          description: 'Je bericht is ontvangen, de reparateur neemt zo snel mogelijk contact met je op.',
