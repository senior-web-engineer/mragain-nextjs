...
import { Input, Button, Popconfirm, DatePicker, Avatar, Checkbox, Select } from 'antd'
...
import { getAppointments, updateAppointment, CancelAppointment } from 'service/appointments/operations.js'
import { uploadImage, getShopIdByInformation } from 'service/account/operations.js'
...
const ShopDashboard = (routerProps) => {
  ...
  }, [isLoadService, isLoad, isLoadAppointment, modelServices, setLoadService, appointmentList, setLoadAppointment])
  ...
  const addReparation = () => {
    ...
    router.push(`/maak-een-afspraak?shop=${shopIdInfo}&initdate=${0}&manual=true`)
  }
    ...
    <Layout>
      <div className='shop-dashboard-page'>
        <Head>
          ...
          <meta name='description' content='Via je dashboard beheer je snel en eenvoudig al je reparaties' />
          ...
          <meta property='og:description' content='Vind de beste reparateur bij jou in de buurt' />
        ...
        <div className='shop-dashboard-page-container'>
          ...
          {state.width < 1020 ? (
            <div className='dashboard-page-widget' style={{ display: display }}>
              ...
              />
              <div className='widget-shop-title'>{account_profile.name !== undefined && account_profile.name}</div>
              ...
              <div className='widget-shop-appointment'>
                <FontAwesomeIcon className='over-icon' icon={['fas', 'chalkboard-teacher']} />
                <Link prefetch={false} href={'/reparatie-overzicht/' + url_shopId}>
                  Reparatie Overzicht
                </Link>
              </div>
              <div className='widget-shop-appointment'>
                <FontAwesomeIcon className='calendar-icon' icon={['fas', 'tasks']} />
                <Link prefetch={false} href={'/apparaten-beheer/' + url_shopId}>
                  Model & Reparatie beheer
                </Link>
              </div>
              <div className='widget-shop-appointment'>
                <FontAwesomeIcon className='calendar-icon' icon={['fas', 'user']} />
                <Link prefetch={false} href={'/profiel-beheer/' + url_shopId}>
                  Profiel
                </Link>
              </div>
              <div className='widget-shop-appointment'>
                <FontAwesomeIcon className='calendar-icon' icon={['fas', 'cogs']} />
            ...
            <div className='dashboard-page-widget' style={{ display: 'block' }}>
              <Avatar
                className='shop-widget-avatar'
                src={
                  account_profile.logo_photo === '' && account_profile.logo_photo !== undefined
                    ? account_profile.bg_photo
                    : account_profile.logo_photo
                }
              />
          ...
          <div className='dashboard-page-content'>
            <div className='dashboard-page-body'>
              ...
              <div className='shop-appointment-table-header w-100'>
                <div className='shop-appointment-table-title'>Ingeplande afspraken</div>
                <div className='sort-by-date'>
                  {showAppointmentModal && (
                    <MakeAppointment shop={account_profile.id} onChangeStatus={() => onChangeModalStatus()} />
                  )}
              ...
              <div className='shop-appointment-table-body'>
                    ...
                    {appointlist.length > 0
                      ? appointlist.map((el) => {
                          if (el.status !== 1) {
                            return (
                              <tr key={el.id}>
                                <td>{(formatDate(el.appointment.date, 'DD-MM-YYYY'), el.appointment.date)}</td>
                ...
                <Modal show={showModal} onHide={handleModalClose} className='reparation-change-modal'>
                  ...
                  <Modal.Body>
                    ...
                    <div className='repair-input-group-image'>
                      ...
                      <div className='image-picker-label'>
                        ...
                        <Button className='image-picker-btn' onClick={handleRemovePicture} disabled={editable}>
                          Verwijder foto
                        </Button>
                      </div>
                    </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    uploadImage: (data, id, name, flg) => uploadImage(data, id, name, flg, dispatch),
