    ...
    <div className="container">
      <Slider {...settings}>
        <div>
          <div>
            <p>
	    Door de samenwerking met MrAgain hoeven we ons minder zorgen 
	    te maken om onze marketing. Klanten maken afspraken bij ons
            </p>
            <p>
	    doordat ze de goede reviews en voorwaarden zien. Hierdoor
	    kunnen wij ons focussen op waar we echt goed in zijn. 
            </p>
            <p>
	    Dat is het repareren van jouw device!
            </p>
          </div>
	    ...
	    mocht dat niet zo zijn dan regelen we het snel. 
            ...
            <p>
	    Voor ons is MrAgain tot nu toe een echte verademing! 
            </p>
          </div>
          <div className="testimonial-icon">
            <FontAwesomeIcon
