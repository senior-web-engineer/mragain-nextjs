...
const FooterView = ({ location ,ua}) => {
  ...
  let notBot = (ua && ua.source && !ua.isBot && (
          ...
          <FooterLinkArea className="footer-link-area">
            <FooterSitemap ClassName="custome-footer-sitename">
              ...
              <ul>
                ...
                <li>
                  <Link prefetch={false} href="/veel-gestelde-vragen">FAQ</Link>
                </li>
                <li>
                  <Link prefetch={false} href="/blog">Blogs</Link>
                </li>
                <li>
                  <Link prefetch={false} href="/reparatie">Reparaties</Link>
                </li>
              </ul>
            </FooterSitemap>
            <FollowUs className="follow-us">
              ...
              <ul>
                ...
                <li className="twitter">
                  <a href="https://twitter.com/MrAgainofficial" target="_blank" rel="noopener noreferrer nofollow">
                    <div className="icon-circle">
                      <i className="anticon">
                        <svg width="1em" height="1em" fill="currentColor" aria-hidden="true" focusable="false"
                             className="">
                ...
                <li className="linkedin">
                  ...
                  >
                    <div className="icon-circle">
                      ...
                      <i aria-label="icon: linkedin" className="anticon anticon-linkedin">
                        <svg viewBox="64 64 896 896" focusable="false" className="" data-icon="linkedin" width="1em"
                ...
                <li className="instagram">
                  ...
                  >
                    <div className="icon-circle">
                      ...
                      <i aria-label="icon: instagram" className="anticon anticon-instagram">
                        <svg viewBox="64 64 896 896" focusable="false" className="" data-icon="instagram" width="1em"
                             height="1em" fill="currentColor" aria-hidden="true">
                          <path
