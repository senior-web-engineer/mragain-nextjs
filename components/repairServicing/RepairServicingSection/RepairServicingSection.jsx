      ...
      <RepairServicingContent>
        <Figure className="repair-servicing-image">
          <Figure.Image
            width={520}
            height={486}
            src={RepairServicingImage}
          />
        </Figure>
        <RepairServicingArticle>
          <RepairServicingArticleTitle>Over MrAgain</RepairServicingArticleTitle>
          <RepairServicingArticleContent>
            ...
            Ip sum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type</p>
          </RepairServicingArticleContent>
          <RepairServicingArticleLink>
